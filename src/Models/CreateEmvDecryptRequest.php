...
class CreateEmvDecryptRequest implements JsonSerializable
{
     ...
     * @todo Write general description for this property
     * @required
     * @var \MundiAPILib\Models\CreateEmvDataDecryptRequest $data public property
     */
    public $data;

    /**
     * @todo Write general description for this property
     * @var \MundiAPILib\Models\CreateCardPaymentContactlessPOIRequest|null $poi public property
     */
    public $poi;
