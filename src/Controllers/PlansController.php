...
class PlansController extends BaseController
{
     ...
     * @param Models\PlansItemsRequest1 $body            Request for creating a plan item
    ...
    public function createPlanItem(
        ...
        return $mapper->mapClass($response->body, 'MundiAPILib\\Models\\PlansItemsResponse');
    }
    ...
    public function getPlans(
        ...
        return $mapper->mapClass($response->body, 'MundiAPILib\\Models\\PlansResponse');
    }
    ...
    public function getPlan(
        ...
        return $mapper->mapClass($response->body, 'MundiAPILib\\Models\\PlansResponse1');
    }
     ...
     * Creates a new plan
     *
     * @param Models\PlansRequest $body            Request for creating a plan
     * @param string              $idempotencyKey  (optional) TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     *
     * @param string               $planId          Plan id
     * @param Models\PlansRequest1 $body            Request for updating a plan
     * @param string               $idempotencyKey  (optional) TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     * @param string                   $planId          Plan id
     * @param string                   $planItemId      Plan item id
     * @param Models\PlansItemsRequest $body            Request for updating the plan item
     * @param string                   $idempotencyKey  (optional) TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     * @param Models\PlansMetadataRequest $body            Request for updating the plan metadata
     * @param string                      $idempotencyKey  (optional) TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function updatePlanMetadata(
        ...
        return $mapper->mapClass($response->body, 'MundiAPILib\\Models\\PlansMetadataResponse');
    }
}
