...
class RecipientsController extends BaseController
{
     ...
     * @param string  $createdSince  (optional) Filter for start range of transfer creation date
     * @param string  $createdUntil  (optional) Filter for end range of transfer creation date
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     * @param string $paymentDate  Anticipation payment date
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
     ...
     * @param string  $paymentDateSince   (optional) Filter for start range for anticipation payment date
     * @param string  $paymentDateUntil   (optional) Filter for end range for anticipation payment date
     * @param string  $createdSince       (optional) Filter for start range for anticipation creation date
     * @param string  $createdUntil       (optional) Filter for end range for anticipation creation date
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
