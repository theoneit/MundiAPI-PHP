...
{
    /**
     * @var \MundiAPILib\Controllers\OrdersController Controller instance
     */
     ...
     * Gets all orders
     */
    public function testTestGetOrders()
    {
        ...
        try {
            $result = self::$controller->getOrders($page, $size, $code, $status, $createdSince, $createdUntil, $customerId);
